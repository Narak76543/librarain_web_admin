...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const normalizeAdminUser = (record) => {
      ...
      if (!(record == null ? void 0 : record.basic_info) && !(record == null ? void 0 : record.account_status)) return record;
      const basic = record.basic_info || {};
      const status = record.account_status || {};
      return {
        id: basic.id || ((_a = record.user) == null ? void 0 : _a.id),
        full_name: basic.full_name || ((_b = record.user) == null ? void 0 : _b.full_name),
        email: basic.email || ((_c = record.user) == null ? void 0 : _c.email),
        phone: basic.phone || ((_d = record.profile) == null ? void 0 : _d.phone) || ((_e = record.user) == null ? void 0 : _e.phone),
        is_active: (_g = basic.is_active) != null ? _g : (_f = record.user) == null ? void 0 : _f.is_active,
        is_verified: (_i = basic.is_verified) != null ? _i : (_h = record.user) == null ? void 0 : _h.is_verified,
        roles: basic.roles || ((_j = record.user) == null ? void 0 : _j.roles) || [],
    ...
    const isLockedUser = (user) => {
      return Boolean(user == null ? void 0 : user.locked_until) || ((user == null ? void 0 : user.failed_login_attempts) || 0) > 0;
    };
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isLoadingDetail.value) {
        ...
        _push(`</h4><div class="flex gap-2 mt-2"><span class="${ssrRenderClass([((_b = selectedUser.value.roles) == null ? void 0 : _b[0]) === "ADMIN" ? "bg-purple-100 text-purple-700" : "bg-surface text-text-secondary", "px-2 py-0.5 rounded text-[11px] font-semibold"])}">${ssrInterpolate(((_c = selectedUser.value.roles) == null ? void 0 : _c[0]) || "USER")}</span>`);
        ...
        if (((_l = selectedUser.value.login_logs) == null ? void 0 : _l.length) > 0) {
