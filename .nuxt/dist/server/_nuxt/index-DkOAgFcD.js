    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (showDeleteModal.value) {
        _push(ssrRenderComponent(_component_ConfirmModal, {
          ...
          message: `Are you sure you want to delete '${catToDelete.value?.name}'? This will also affect ${catToDelete.value?.books_count || 0} books.`,
          confirmLabel: "Delete",
...
//# sourceMappingURL=index-DkOAgFcD.js.map
