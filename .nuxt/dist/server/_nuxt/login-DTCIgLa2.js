...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</button></form><div class="mt-8 text-center flex flex-col items-center"><p class="text-[12px] text-text-secondary">BookStore Admin Panel</p><p class="text-[11px] text-text-secondary mt-0.5">© 2026 All rights reserved</p></div></div></div>`);
    };
  }
};
...
//# sourceMappingURL=login-DTCIgLa2.js.map
