...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-EhY90qR8.js")
  },
  {
    name: "login",
    path: "/login",
  ...
  },
  {
    name: "books",
    path: "/books",
    component: () => import("./_nuxt/index-BG8EMzTC.js")
  },
  {
    name: "users",
    path: "/users",
    component: () => import("./_nuxt/index-C1zOiTf-.js")
  },
  {
    name: "orders",
    path: "/orders",
    component: () => import("./_nuxt/index-fOsO4byp.js")
  },
  {
    name: "settings",
    path: "/settings",
  ...
  },
  {
    name: "categories",
    path: "/categories",
    component: () => import("./_nuxt/index-CPSi_WvW.js")
  }
];
